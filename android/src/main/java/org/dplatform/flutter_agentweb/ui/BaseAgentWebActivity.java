...
public abstract class BaseAgentWebActivity extends AppCompatActivity {
    ...
    protected abstract void registerJockeyEvents();

    protected void onJs(String type, JockeyHandler... handler) {
        mJockey.on(type, handler);
    }

    protected void sendJs(String type, Object withPayload, JockeyCallback complete) {
        mJockey.send(type, mAgentWeb.getWebCreator().getWebView(), withPayload, complete);
    }
