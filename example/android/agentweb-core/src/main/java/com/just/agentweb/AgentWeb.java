...
public final class AgentWeb {
    ...
    private JockeyJsConfigure mJockeyJsConfigure;
    ...
    private AgentWeb(AgentBuilder agentBuilder) {
        ...
        this.mJockeyJsConfigure = agentBuilder.mJockeyJsConfigure;
        init();
    }
    ...
    private AgentWeb ready() {
        ...
        if (mJockeyJsConfigure != null) {
            mJockeyJsConfigure.configure(mWebCreator.getWebView(), getWebViewClient());
        }
        return this;
    }
    ...
    public static class CommonBuilder {
        ...
        public CommonBuilder setJockeyJsConfigure(JockeyJsConfigure jockeyJsConfigure) {
            this.mAgentBuilder.mJockeyJsConfigure = jockeyJsConfigure;
            return this;
        }
    }
